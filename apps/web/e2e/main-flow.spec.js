...
test('main flow: sign-in, upload, ingest, quiz, attempt, dashboard, chat, citation jump', async ({ page }) => {
  await page.goto('/');
  ...
  // Chat dock
  await page.fill('input[placeholder="Ask a question..."]', 'What is kinematics?');
